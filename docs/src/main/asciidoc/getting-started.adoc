...
However, nodes are not ready yet, they are started in a new *DIAGNOSTIC* mode, which means that they are waiting for the user to attach them to the cluster, and to be activated (being part of a stripe)
